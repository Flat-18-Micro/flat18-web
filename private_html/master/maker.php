...
$url = isset($_SERVER['SERVER_NAME']) ? $_SERVER['SERVER_NAME'] : "new.flat18.co.uk";
...
foreach ($dir as $fileinfo) {
  if (!$fileinfo->isDot()) {
    ...
    switch ($n) {
      case 'homepage':
        //HOMEPAGE-SPECIFIC 
        // include_once(__DIR__ . "/pages/homepage/body.php");
    ...
    doClone("src/img");
    doClone("workers");
    file_put_contents($dest . "index.php", $tmpl);
    echo ("<br>Built " . $n . "\n\n");
  }
}
